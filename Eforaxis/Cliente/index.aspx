<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Eforaxis.Cliente.index" %>
    ...
    <div class="container">
        <div class="card">
            ...
            <form id="registroAdmin" class="card__form" runat="server">
                ...
                <button class="card__button btn--register"><a href="registroCliente.aspx">Registrar</a></button>/>
            </form>
        </div>
    </div>
</body>
